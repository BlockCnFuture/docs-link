...
![](/img/en-img/CorridorWayline/LRExtensionDistance/5.png)

### Flip AOI

For corridor missions, click the ![](/img/en-img/CorridorWayline/LRExtensionDistance/3.png) button to flip the centerline and swap left and right directions.
...
![](/img/en-img/CorridorWayline/LRExtensionDistance/0.png)
...
![](/img/en-img/CorridorWayline/LRExtensionDistance/4.png)

### Extension Distance Sync

Click the ![](/img/en-img/CorridorWayline/LRExtensionDistance/2.png) button to disable synchronization of left and right extension distances, enabling separate distance values for the left and right sides.
