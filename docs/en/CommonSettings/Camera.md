...
:::tip
Different cameras have different image capture speeds, corresponding to different maximum flight speed limits. Therefore, select the camera matching your actual flight when planning flight missions.
:::
...
:::warning
For consumer drones, manually set the camera on the remote controller before starting the flight mission. The setting must match the one configured in the mission. Do not enable zoom; otherwise, the overlap of captured data may be incorrect and prevent successful reconstruction.
:::
