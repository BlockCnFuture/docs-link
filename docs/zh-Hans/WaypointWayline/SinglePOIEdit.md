...
![](/img/cn-img/WaypointWayline/SinglePOIEdit/image-0.gif)

### 2. 兴趣点右键菜单
在左侧面板选中某个兴趣点后右键

![](/img/cn-img/WaypointWayline/SinglePOIEdit/image-0.png)

可删除兴趣点、将兴趣点快速应用到所有航点等

![](/img/cn-img/WaypointWayline/SinglePOIEdit/image-1.png)
